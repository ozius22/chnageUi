...
<body>
    ...
    <div class="w-full h-screen bg-image flex flex-col justify-center items-center">
        ...
        <strong class="text-[#ffdcc2] font-light md:font-normal text-xs md:text-lg md:mb-96">Question <?php echo $currentQuestion + 1 ?> :</strong> <span class="text-[#ffc599] text-sm font-bold md:text-3xl"><?php echo $questions[$currentQuestion]; ?></span><br>
            <?php
